...
def gen_log_stat(args: argparse.Namespace, elapsed_time, net, optimizer, epoch, train_stat=None, val_stat=None,
    ...
    if args.step == 'feature_extr':
        backbone = args.TF_backbone
        hidden_size = args.TF_hidden_size
    elif args.step == 'classify' or args.step == 'pretrain_cla':
        backbone = args.Classification_backbone
        hidden_size = args.Classification_hidden_size
