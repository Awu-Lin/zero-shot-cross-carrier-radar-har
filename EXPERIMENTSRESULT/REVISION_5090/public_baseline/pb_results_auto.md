...
|---|---|---|---|---|---|---|---|---|
| 9 | DINOv3 ViT-L/16 + LoRA-only (no DAS/ACR) | 0.302 ± 0.031 | 0.413 ± 0.025 | 0.970 ± 0.005 | +0.668 | 1.85 | - | [0.298, 0.356] |
| 10 | Proposed (DINOv3+LoRA+DAS+ACR) -- single | 0.832 ± 0.034 | 0.836 ± 0.032 | 0.967 ± 0.006 | +0.135 | 1.85 | - | [0.751, 0.826] |
...
|---|---|---|---|---|---|---|---|---|
| DINOv3 ViT-L/16 + LoRA-only (no DAS/ACR) | 0.70 | 0.50 | 0.27 | 0.01 | 0.08 | 0.00 | 0.56 | 0.00 |
| Proposed (DINOv3+LoRA+DAS+ACR) -- single | 0.96 | 0.79 | 0.82 | 0.82 | 0.88 | 0.72 | 0.84 | 0.72 |
