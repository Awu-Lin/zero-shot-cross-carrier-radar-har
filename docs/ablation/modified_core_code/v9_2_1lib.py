# ============================================================================
# INTRODUCTION
# Model + data + augmentation library (DINOv3 backbone, LoRA, DAS Doppler-stretch operator, heads,
# EMA, GPU aug, loaders). MODIFIED FOR THIS ABLATION (defaults byte-identical): CarrierAdversary
# gained an out_dim arg (1=original continuous regressor; K=discrete K-bin head); added
# das_log_carrier_range() returning the DAS log-carrier span used to bin the discrete adversary.
# See CODE_CHANGES.diff.
# ============================================================================
