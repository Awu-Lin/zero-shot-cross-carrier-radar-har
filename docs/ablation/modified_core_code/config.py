# ============================================================================
# INTRODUCTION
# Central configuration (frozen DINOv3 ViT-L/16 + LoRA r2 + ArcFace/LogitAdjust + SupCon + MIRO
# + EMA + DAS + ACR). MODIFIED FOR THIS ABLATION (env-gated, defaults byte-identical):
#  (a) USE_HFT / USE_SPEC_AUGMENT env-gated (V921_USE_HFT / V921_USE_SPEC_AUGMENT, default '1');
#  (b) added V13_GRL_DISCRETE / V13_GRL_BINS to switch the carrier adversary from our continuous
#      log-carrier regressor to a K-bin classifier (P0-A discrete control). See CODE_CHANGES.diff.
# ============================================================================
